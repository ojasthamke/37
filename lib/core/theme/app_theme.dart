...
class AppTheme {
  ...
  static const Color bgLightScaffold = Color(0xFFF8F9FA);
  static const Color bgLightSurface = Color(0xFFFFFFFF);
  static const Color borderLightNeutral = Color(0xFFE9ECEF);
  static const Color borderLightInput = Color(0xFFDEE2E6);
  ...
  static ThemeData get darkTheme => lightTheme; // Keep light theme unified by default for store look
}
